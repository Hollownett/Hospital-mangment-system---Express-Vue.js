const ptBR = {
  ...
  entities: {
    medBooks: {
      ...
      label: 'medBooks',
      menu: 'medBooks',
      exporterFileName: 'medBooks_exportados',
      list: {
        menu: 'medBooks',
        title: 'medBooks',
      },
      create: {
        success: 'medBooks salvo com sucesso',
      },
      update: {
        success: 'medBooks salvo com sucesso',
      },
      destroy: {
        success: 'medBooks deletado com sucesso',
      },
      destroyAll: {
        success: 'medBooks(s) deletado com sucesso',
      },
      edit: {
        title: 'Editar medBooks',
      },
      fields: {
        id: 'Id',
        'patient': 'patient',
      ...
      view: {
        title: 'Visualizar medBooks',
      },
      importer: {
        title: 'Importar medBooks',
        fileName: 'medBooks_template_importacao',
        hint:
  ...
  roles: {
    ...
    medBooksEditor: {
      label: 'Editor de medBooks',
      description: 'Acesso de edição aos medBooks',
    },
    medBooksViewer: {
      label: 'Visualizador de medBooks',
      description: 'Acesso de visualização aos medBooks',
    },
    bookEditor: {
