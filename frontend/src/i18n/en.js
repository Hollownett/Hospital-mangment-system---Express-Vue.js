...
const en = {
  ...
  entities: {
    medBooks: {
      ...
      exporterFileName: 'medBooks_export',
      list: {
        menu: 'Medical records',
      ...
      destroyAll: {
        success: 'Medical record(s) deleted successfully',
      },
      edit: {
      ...
      importer: {
        ...
        fileName: 'medBooks_import_template',
        hint:
  ...
  roles: {
    ...
    medBooksEditor: {
      label: 'Medical record Editor',
      description: 'Edit access to Medical records',
    },
    medBooksViewer: {
      label: 'Medical record Viewer',
      description: 'View access to Medical records',
    },
    bookEditor: {
